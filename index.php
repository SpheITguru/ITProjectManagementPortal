...
<body> 
    ...
    <div class="banner">
        <div class="content">
            <h2>IT Project Management Portal</h2>
            <p>Welcome to the center of knowledge where brilliant people meet. In this portal, 
			you will meet with sponsors, lecture, and other students that are good as you, more importantly, 
